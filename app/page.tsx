        ...
        <div className="container mx-auto px-4">
          ...
          {isLoading ? (
              ...
              {rides.map((ride, index) => (
                ...
                >
                  <div className="relative h-48">
                    <Image
                      src={ride.image || "/placeholder.svg?height=300&width=500"}
                      alt={ride.title}
                      fill
            ...
            <div className="text-center py-8">
              <p className="text-gray-500">Er zijn momenteel geen geplande ritten.</p>
              <Link
                href="/rides"
                className="mt-4 inline-block bg-olive-600 hover:bg-olive-700 text-white py-2 px-4 rounded-md transition-colors duration-300"
              >
                Bekijk eerdere ritten
              </Link>
            </div>
          )}
        </div>
