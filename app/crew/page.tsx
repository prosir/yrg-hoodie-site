  ...
  return (
    <div className="min-h-screen bg-background">
          ...
          <div className="flex items-center gap-4 mt-4 md:mt-0">
            <nav>
              <ul className="flex space-x-6">
                ...
                <li>
                  <Link href="/crew" className="text-primary font-medium">
                    Crew
                  </Link>
                </li>
              </ul>
      ...
      <main className="container mx-auto px-4 py-12 max-w-3xl">
        <h1 className="text-3xl font-bold mb-8 text-center">YoungRidersOost Crew Toegang</h1>
        ...
        {isSubmitted ? (
            ...
            <Alert>
              ...
              <AlertDescription>
                ...
                <p className="mt-2 text-sm text-muted-foreground">
                  Neem contact op als je vragen hebt over je bestelling.
                </p>
          ...
          <div className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                Dit gedeelte is alleen toegankelijk voor YoungRidersOost crew leden. Voer je toegangscode in om verder
                te gaan.
              </AlertDescription>
            </Alert>
      ...
      <footer className="bg-secondary/10 border-t py-8 mt-12">
